...
project="ndscm-prod"
region="us-west1"
service="seed-cloud-sfe-certificate-prod"
image_package="us-docker.pkg.dev/ndscm-prod/container-us/seed-cloud-sfe-certificate-deploy-gcloud"

export CONTAINER_ENGINE="${container_engine}"
./seed/cloud/sfe/certificate/container/build.sh

cd ./seed/cloud/sfe/certificate/deploy/gcloud/
