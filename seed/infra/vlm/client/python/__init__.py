...
@seed_typing.unbind_callable_type(VlmClient.request_expect_pydantic)
async def request_expect_pydantic(*args, **kwargs):
    return await _client.request_expect_pydantic(*args, **kwargs)


@seed_typing.unbind_callable_type(VlmClient.request_expect_list)
async def request_expect_list(*args, **kwargs):
    return await _client.request_expect_list(*args, **kwargs)


@seed_typing.unbind_callable_type(VlmClient.request_expect_pydantic_list)
